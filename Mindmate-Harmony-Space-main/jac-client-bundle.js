/**
 * jac-client bundle for browser usage
 * Standalone version that can be included via script tag
 */
...
(function(global) {
    ...
    function jacIsLoggedIn() {
        return !!__getLocalStorage("jac_token");
    }
    ...
    global.jacSpawn = jacSpawn;
    global.jacCallFunction = jacCallFunction;
    global.jacSignup = jacSignup;
    global.jacLogin = jacLogin;
    global.jacLogout = jacLogout;
    global.jacIsLoggedIn = jacIsLoggedIn;
